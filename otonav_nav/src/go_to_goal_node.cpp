...
public:
  ...
  : rclcpp::Node("otonav_nav")
  {
    ...
    scan_sub_ = create_subscription<sensor_msgs::msg::LaserScan>(
      ...
      [this](sensor_msgs::msg::LaserScan::SharedPtr msg) { scan_ = *msg; have_scan_ = true; });
    ...
    timer_ = create_wall_timer(
      std::chrono::duration<double>(1.0 / control_rate), [this]() { control_step(); });
  }
  ...
  void control_step()
  {
    ...
    if (have_scan_) {
      blocked = obstacle_ahead(
        scan_.ranges, scan_.angle_min, scan_.angle_increment, front_half_angle_,
